...
var file_db_pipeline_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd0, 0x08, 0x0a, 0x07, 0x44,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x42, 0x07, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x43, 0x0a,
	...
	0x65, 0x73, 0x22, 0xa7, 0x05, 0x0a, 0x10, 0x44, 0x42, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52,
	...
	0x35, 0x0a, 0x0a, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x64, 0x62, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x00, 0x52, 0x09, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x48, 0x0a, 0x0c, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x73,
	...
	0x65, 0x48, 0x00, 0x52, 0x0b, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	0x42, 0x0a, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x51, 0x0a, 0x12,
	0x44, 0x42, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69,
	0x6e, 0x65, 0x12, 0x3b, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x64, 0x62, 0x2e, 0x70, 0x69, 0x70, 0x65, 0x6c,
	0x69, 0x6e, 0x65, 0x2e, 0x44, 0x42, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	...
	0x2d, 0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x64, 0x62, 0x2f, 0x70, 0x69, 0x70, 0x65,
...
var file_db_pipeline_proto_goTypes = []any{
	...
	(*server.Unit)(nil),                         // 22: db.server.Unit
	(*server.Pong)(nil),                         // 23: db.server.Pong
	(*server.ClientList)(nil),                   // 24: db.server.ClientList
	(*server.StoreList)(nil),                    // 25: db.server.StoreList
	(*server.InfoServer)(nil),                   // 26: db.server.InfoServer
	(*server.Set)(nil),                          // 27: db.server.Set
	(*server.Get)(nil),                          // 28: db.server.Get
	(*server.GetSimN)(nil),                      // 29: db.server.GetSimN
	(*server.Del)(nil),                          // 30: db.server.Del
	(*server.CreateIndex)(nil),                  // 31: db.server.CreateIndex
	(*info.ErrorResponse)(nil),                  // 32: shared.info.ErrorResponse
	(*server.StoreInfo)(nil),                    // 33: db.server.StoreInfo
...
var file_db_pipeline_proto_depIdxs = []int32{
	...
	0,  // 18: db.pipeline.DBRequestPipeline.queries:type_name -> db.pipeline.DBQuery
	22, // 19: db.pipeline.DBServerResponse.unit:type_name -> db.server.Unit
	23, // 20: db.pipeline.DBServerResponse.pong:type_name -> db.server.Pong
	24, // 21: db.pipeline.DBServerResponse.client_list:type_name -> db.server.ClientList
	25, // 22: db.pipeline.DBServerResponse.store_list:type_name -> db.server.StoreList
	26, // 23: db.pipeline.DBServerResponse.info_server:type_name -> db.server.InfoServer
	27, // 24: db.pipeline.DBServerResponse.set:type_name -> db.server.Set
	28, // 25: db.pipeline.DBServerResponse.get:type_name -> db.server.Get
	29, // 26: db.pipeline.DBServerResponse.get_sim_n:type_name -> db.server.GetSimN
	30, // 27: db.pipeline.DBServerResponse.del:type_name -> db.server.Del
	31, // 28: db.pipeline.DBServerResponse.create_index:type_name -> db.server.CreateIndex
	32, // 29: db.pipeline.DBServerResponse.error:type_name -> shared.info.ErrorResponse
	33, // 30: db.pipeline.DBServerResponse.store_info:type_name -> db.server.StoreInfo
	34, // 31: db.pipeline.DBServerResponse.cluster_info:type_name -> shared.cluster.ClusterInfoResponse
	2,  // 32: db.pipeline.DBResponsePipeline.responses:type_name -> db.pipeline.DBServerResponse
