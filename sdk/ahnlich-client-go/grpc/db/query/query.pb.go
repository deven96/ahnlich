...
var file_db_query_proto_rawDesc = []byte{
	...
	0x67, 0x22, 0x20, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x14, 0x0a,
	0x05, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x22, 0x49, 0x0a, 0x03, 0x53, 0x65, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74,
	0x6f, 0x72, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x6f, 0x72, 0x65,
	0x12, 0x2c, 0x0a, 0x06, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x14, 0x2e, 0x6b, 0x65, 0x79, 0x76, 0x61, 0x6c, 0x2e, 0x44, 0x62, 0x53, 0x74, 0x6f, 0x72,
	0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x42, 0x46,
	...
	0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x64, 0x62, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79,
...
var file_db_query_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_db_query_proto_goTypes = []any{
	...
	(*Set)(nil),                           // 16: db.query.Set
	(*nonlinear.NonLinearIndex)(nil),      // 17: algorithm.nonlinear.NonLinearIndex
	...
	(nonlinear.NonLinearAlgorithm)(0),     // 21: algorithm.nonlinear.NonLinearAlgorithm
	(*keyval.DbStoreEntry)(nil),           // 22: keyval.DbStoreEntry
}
var file_db_query_proto_depIdxs = []int32{
	17, // 0: db.query.CreateStore.non_linear_indices:type_name -> algorithm.nonlinear.NonLinearIndex
	18, // 1: db.query.GetKey.keys:type_name -> keyval.StoreKey
	19, // 2: db.query.GetPred.condition:type_name -> predicates.PredicateCondition
	18, // 3: db.query.GetSimN.search_input:type_name -> keyval.StoreKey
	20, // 4: db.query.GetSimN.algorithm:type_name -> algorithm.algorithms.Algorithm
	19, // 5: db.query.GetSimN.condition:type_name -> predicates.PredicateCondition
	17, // 6: db.query.CreateNonLinearAlgorithmIndex.non_linear_indices:type_name -> algorithm.nonlinear.NonLinearIndex
	21, // 7: db.query.DropNonLinearAlgorithmIndex.non_linear_indices:type_name -> algorithm.nonlinear.NonLinearAlgorithm
	18, // 8: db.query.DelKey.keys:type_name -> keyval.StoreKey
	19, // 9: db.query.DelPred.condition:type_name -> predicates.PredicateCondition
	22, // 10: db.query.Set.inputs:type_name -> keyval.DbStoreEntry
