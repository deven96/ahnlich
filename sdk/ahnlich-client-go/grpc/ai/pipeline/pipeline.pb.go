...
func (x *AIQuery) GetDropSchema() *query.DropSchema {
	if x, ok := x.GetQuery().(*AIQuery_DropSchema); ok {
		return x.DropSchema
	}
	return nil
}

func (x *AIQuery) GetUpsert() *query.Upsert {
	if x, ok := x.GetQuery().(*AIQuery_Upsert); ok {
		return x.Upsert
	}
	return nil
}

func (x *AIQuery) GetListStoreEntries() *query.ListStoreEntries {
	if x, ok := x.GetQuery().(*AIQuery_ListStoreEntries); ok {
		return x.ListStoreEntries
	}
	return nil
}

func (x *AIQuery) GetClearStore() *query.ClearStore {
	if x, ok := x.GetQuery().(*AIQuery_ClearStore); ok {
		return x.ClearStore
	}
	return nil
}
...
type AIQuery_DropSchema struct {
	DropSchema *query.DropSchema `protobuf:"bytes,20,opt,name=drop_schema,json=dropSchema,proto3,oneof"`
}

type AIQuery_Upsert struct {
	Upsert *query.Upsert `protobuf:"bytes,21,opt,name=upsert,proto3,oneof"`
}

type AIQuery_ListStoreEntries struct {
	ListStoreEntries *query.ListStoreEntries `protobuf:"bytes,22,opt,name=list_store_entries,json=listStoreEntries,proto3,oneof"`
}

type AIQuery_ClearStore struct {
	ClearStore *query.ClearStore `protobuf:"bytes,23,opt,name=clear_store,json=clearStore,proto3,oneof"`
}
...
func (*AIQuery_DropSchema) isAIQuery_Query() {}

func (*AIQuery_Upsert) isAIQuery_Query() {}

func (*AIQuery_ListStoreEntries) isAIQuery_Query() {}

func (*AIQuery_ClearStore) isAIQuery_Query() {}
...
type AIServerResponse struct {
	...
	//	*AIServerResponse_ListStoreEntries
...
func (x *AIServerResponse) GetListStoreEntries() *server.ListStoreEntries {
	if x, ok := x.GetResponse().(*AIServerResponse_ListStoreEntries); ok {
		return x.ListStoreEntries
	}
	return nil
}
...
type AIServerResponse_ListStoreEntries struct {
...
func (*AIServerResponse_ListStoreEntries) isAIServerResponse_Response() {}
...
var file_ai_pipeline_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x0b, 0x0a, 0x07, 0x41, 0x49, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	,
	...
	0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x61, 0x69, 0x2e, 0x73, 0x65,
	...
	0x0b, 0x32, 0x14, 0x2e, 0x61, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x74,
	...
	0x76, 0x65, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x61, 0x69, 0x2e, 0x73,
	...
	0x0a, 0x03, 0x73, 0x65, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x61, 0x69,
	...
	0x0e, 0x2e, 0x61, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x48,
	0x00, 0x52, 0x03, 0x67, 0x65, 0x74, 0x12, 0x30, 0x0a, 0x09, 0x67, 0x65, 0x74, 0x5f, 0x73, 0x69,
	0x6d, 0x5f, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x69, 0x2e, 0x73,
	...
	0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x61, 0x69, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65,
	...
	,
	...
	0x2d, 0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x61, 0x69, 0x2f, 0x70, 0x69, 0x70, 0x65,
...
var file_ai_pipeline_proto_goTypes = []any{
	...
	(*query.DropSchema)(nil),                    // 23: ai.query.DropSchema
	(*query.Upsert)(nil),                        // 24: ai.query.Upsert
	(*query.ListStoreEntries)(nil),              // 25: ai.query.ListStoreEntries
	(*query.ClearStore)(nil),                    // 26: ai.query.ClearStore
	(*server.Unit)(nil),                         // 27: ai.server.Unit
	(*server.Pong)(nil),                         // 28: ai.server.Pong
	...
	(*server.Set)(nil),                          // 32: ai.server.Set
	(*server.Get)(nil),                          // 33: ai.server.Get
	(*server.GetSimN)(nil),                      // 34: ai.server.GetSimN
	(*server.Del)(nil),                          // 35: ai.server.Del
	(*server.CreateIndex)(nil),                  // 36: ai.server.CreateIndex
	(*info.ErrorResponse)(nil),                  // 37: shared.info.ErrorResponse
	(*server.StoreInputToEmbeddingsList)(nil),   // 38: ai.server.StoreInputToEmbeddingsList
	(*server.AIStoreInfo)(nil),                  // 39: ai.server.AIStoreInfo
	(*server.ListStoreEntries)(nil),             // 40: ai.server.ListStoreEntries
}
var file_ai_pipeline_proto_depIdxs = []int32{
	...
	23, // 19: ai.pipeline.AIQuery.drop_schema:type_name -> ai.query.DropSchema
	24, // 20: ai.pipeline.AIQuery.upsert:type_name -> ai.query.Upsert
	25, // 21: ai.pipeline.AIQuery.list_store_entries:type_name -> ai.query.ListStoreEntries
	26, // 22: ai.pipeline.AIQuery.clear_store:type_name -> ai.query.ClearStore
	0,  // 23: ai.pipeline.AIRequestPipeline.queries:type_name -> ai.pipeline.AIQuery
	27, // 24: ai.pipeline.AIServerResponse.unit:type_name -> ai.server.Unit
	28, // 25: ai.pipeline.AIServerResponse.pong:type_name -> ai.server.Pong
	29, // 26: ai.pipeline.AIServerResponse.client_list:type_name -> ai.server.ClientList
	30, // 27: ai.pipeline.AIServerResponse.store_list:type_name -> ai.server.StoreList
	31, // 28: ai.pipeline.AIServerResponse.info_server:type_name -> ai.server.InfoServer
	32, // 29: ai.pipeline.AIServerResponse.set:type_name -> ai.server.Set
	33, // 30: ai.pipeline.AIServerResponse.get:type_name -> ai.server.Get
	34, // 31: ai.pipeline.AIServerResponse.get_sim_n:type_name -> ai.server.GetSimN
	35, // 32: ai.pipeline.AIServerResponse.del:type_name -> ai.server.Del
	36, // 33: ai.pipeline.AIServerResponse.create_index:type_name -> ai.server.CreateIndex
	37, // 34: ai.pipeline.AIServerResponse.error:type_name -> shared.info.ErrorResponse
	38, // 35: ai.pipeline.AIServerResponse.store_input_to_embeddings_list:type_name -> ai.server.StoreInputToEmbeddingsList
	39, // 36: ai.pipeline.AIServerResponse.store_info:type_name -> ai.server.AIStoreInfo
	40, // 37: ai.pipeline.AIServerResponse.list_store_entries:type_name -> ai.server.ListStoreEntries
	2,  // 38: ai.pipeline.AIResponsePipeline.responses:type_name -> ai.pipeline.AIServerResponse
...
func file_ai_pipeline_proto_init() {
	...
	file_ai_pipeline_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*AIQuery_DropSchema)(nil),
		(*AIQuery_Upsert)(nil),
		(*AIQuery_ListStoreEntries)(nil),
		(*AIQuery_ClearStore)(nil),
	}
	file_ai_pipeline_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*AIServerResponse_ListStoreEntries)(nil),
	}
	type x struct{}
