...
func (x *MetadataValue) GetRawString() string {
	if x, ok := x.GetValue().(*MetadataValue_RawString); ok {
		return x.RawString
	}
	return ""
}

func (x *MetadataValue) GetImage() []byte {
	if x, ok := x.GetValue().(*MetadataValue_Image); ok {
		return x.Image
	}
	return nil
}

func (x *MetadataValue) GetAudio() []byte {
	if x, ok := x.GetValue().(*MetadataValue_Audio); ok {
		return x.Audio
	}
	return nil
}
...
type MetadataValue_RawString struct {
	RawString string `protobuf:"bytes,2,opt,name=raw_string,json=rawString,proto3,oneof"`
}

type MetadataValue_Image struct {
	Image []byte `protobuf:"bytes,3,opt,name=image,proto3,oneof"`
}

type MetadataValue_Audio struct {
	Audio []byte `protobuf:"bytes,4,opt,name=audio,proto3,oneof"`
}

func (*MetadataValue_RawString) isMetadataValue_Value() {}

func (*MetadataValue_Image) isMetadataValue_Value() {}

func (*MetadataValue_Audio) isMetadataValue_Value() {}
...
var file_metadata_proto_rawDesc = []byte{
	...
	,
	...
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2d, 0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x6d,
...
var file_metadata_proto_goTypes = []any{
	(*MetadataValue)(nil), // 0: metadata.MetadataValue
}
...
func file_metadata_proto_init() {
	...
	file_metadata_proto_msgTypes[0].OneofWrappers = []any{
		(*MetadataValue_RawString)(nil),
		(*MetadataValue_Image)(nil),
		(*MetadataValue_Audio)(nil),
	}
	type x struct{}
