...
func (obj *Array) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU8(obj.V); err != nil {
		return err
	}
	if err := serialize_tuple1_u64(obj.Dim, serializer); err != nil {
		return err
	}
	if err := serialize_vector_f32(obj.Data, serializer); err != nil {
		return err
	}
...
func DeserializeArray(deserializer serde.Deserializer) (Array, error) {
	...
	if val, err := deserialize_tuple1_u64(deserializer); err == nil {
		obj.Dim = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_f32(deserializer); err == nil {
		obj.Data = val
	} else {
		return obj, err
	}
...
func (obj *ConnectedClient) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeStr(obj.Address); err != nil {
		return err
	}
	if err := obj.TimeConnected.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeConnectedClient(deserializer serde.Deserializer) (ConnectedClient, error) {
	...
	if val, err := DeserializeSystemTime(deserializer); err == nil {
		obj.TimeConnected = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func load_MetadataValue__RawString(deserializer serde.Deserializer) (MetadataValue__RawString, error) {
	var obj string
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (MetadataValue__RawString)(obj), err
	}
	if val, err := deserializer.DeserializeStr(); err == nil {
		obj = val
	} else {
...
func load_MetadataValue__Binary(deserializer serde.Deserializer) (MetadataValue__Binary, error) {
	var obj []uint8
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (MetadataValue__Binary)(obj), err
	}
...
func load_Result__Ok(deserializer serde.Deserializer) (Result__Ok, error) {
	...
	if val, err := DeserializeServerResponse(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func (obj *ServerInfo) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Version.Serialize(serializer); err != nil {
		return err
	}
	if err := obj.Type.Serialize(serializer); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.Limit); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.Remaining); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeServerInfo(deserializer serde.Deserializer) (ServerInfo, error) {
	...
	if val, err := DeserializeServerType(deserializer); err == nil {
		obj.Type = val
	} else {
		return obj, err
	}
...
func (obj *ServerResponse__ClientList) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_ConnectedClient((([]ConnectedClient)(*obj)), serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_ServerResponse__ClientList(deserializer serde.Deserializer) (ServerResponse__ClientList, error) {
	var obj []ConnectedClient
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ServerResponse__ClientList)(obj), err
	}
	if val, err := deserialize_vector_ConnectedClient(deserializer); err == nil {
		obj = val
	} else {
		return ((ServerResponse__ClientList)(obj)), err
	}
...
func (obj *ServerResponse__StoreList) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_StoreInfo((([]StoreInfo)(*obj)), serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_ServerResponse__StoreList(deserializer serde.Deserializer) (ServerResponse__StoreList, error) {
	var obj []StoreInfo
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ServerResponse__StoreList)(obj), err
	}
	if val, err := deserialize_vector_StoreInfo(deserializer); err == nil {
		obj = val
	} else {
		return ((ServerResponse__StoreList)(obj)), err
	}
...
func load_ServerResponse__InfoServer(deserializer serde.Deserializer) (ServerResponse__InfoServer, error) {
	...
	if val, err := DeserializeServerInfo(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_ServerResponse__Set(deserializer serde.Deserializer) (ServerResponse__Set, error) {
	...
	if val, err := DeserializeStoreUpsert(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
type ServerResponse__Get []struct {
	Field0 Array
	Field1 map[string]MetadataValue
}
...
func (obj *ServerResponse__Get) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_tuple2_Array_map_str_to_MetadataValue((([]struct {
		Field0 Array
		Field1 map[string]MetadataValue
	})(*obj)), serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_ServerResponse__Get(deserializer serde.Deserializer) (ServerResponse__Get, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ServerResponse__Get)(obj), err
	}
	if val, err := deserialize_vector_tuple2_Array_map_str_to_MetadataValue(deserializer); err == nil {
		obj = val
	} else {
		return ((ServerResponse__Get)(obj)), err
	}
...
type ServerResponse__GetSimN []struct {
	Field0 Array
	Field1 map[string]MetadataValue
	Field2 Similarity
}
...
func (obj *ServerResponse__GetSimN) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_tuple3_Array_map_str_to_MetadataValue_Similarity((([]struct {
		Field0 Array
		Field1 map[string]MetadataValue
		Field2 Similarity
	})(*obj)), serializer); err != nil {
...
func load_ServerResponse__GetSimN(deserializer serde.Deserializer) (ServerResponse__GetSimN, error) {
	...
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ServerResponse__GetSimN)(obj), err
	}
	if val, err := deserialize_vector_tuple3_Array_map_str_to_MetadataValue_Similarity(deserializer); err == nil {
		obj = val
	} else {
		return ((ServerResponse__GetSimN)(obj)), err
	}
...
func load_ServerResponse__Del(deserializer serde.Deserializer) (ServerResponse__Del, error) {
	var obj uint64
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ServerResponse__Del)(obj), err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj = val
	} else {
...
func load_ServerResponse__CreateIndex(deserializer serde.Deserializer) (ServerResponse__CreateIndex, error) {
	var obj uint64
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (ServerResponse__CreateIndex)(obj), err
	}
	if val, err := deserializer.DeserializeU64(); err == nil {
		obj = val
	} else {
...
func (obj *ServerResult) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_Result(obj.Results, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeServerResult(deserializer serde.Deserializer) (ServerResult, error) {
	...
	if val, err := deserialize_vector_Result(deserializer); err == nil {
		obj.Results = val
	} else {
		return obj, err
	}
...
func (obj *Similarity) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeF32(((float32)(*obj))); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeSimilarity(deserializer serde.Deserializer) (Similarity, error) {
	var obj float32
	if err := deserializer.IncreaseContainerDepth(); err != nil {
		return (Similarity)(obj), err
	}
	if val, err := deserializer.DeserializeF32(); err == nil {
		obj = val
	} else {
		return ((Similarity)(obj)), err
	}
...
func (obj *StoreInfo) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.SizeInBytes); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *StoreUpsert) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.Inserted); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.Updated); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *SystemTime) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU64(obj.SecsSinceEpoch); err != nil {
		return err
	}
	if err := serializer.SerializeU32(obj.NanosSinceEpoch); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *Version) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeU8(obj.Major); err != nil {
		return err
	}
...
func deserialize_map_str_to_MetadataValue(deserializer serde.Deserializer) (map[string]MetadataValue, error) {
	...
	for i := 0; i < int(length); i++ {
		...
		if val, err := DeserializeMetadataValue(deserializer); err == nil {
			obj[key] = val
		} else {
			return nil, err
		}
...
func serialize_tuple1_u64(value struct{ Field0 uint64 }, serializer serde.Serializer) error {
	if err := serializer.SerializeU64(value.Field0); err != nil {
		return err
	}
	return nil
}
...
func serialize_tuple2_Array_map_str_to_MetadataValue(value struct {
	Field0 Array
	Field1 map[string]MetadataValue
	...
	if err := serialize_map_str_to_MetadataValue(value.Field1, serializer); err != nil {
		return err
	}
	return nil
}

func deserialize_tuple2_Array_map_str_to_MetadataValue(deserializer serde.Deserializer) (struct {
	Field0 Array
	Field1 map[string]MetadataValue
}, error) {
	var obj struct {
	...
	if val, err := DeserializeArray(deserializer); err == nil {
		obj.Field0 = val
	} else {
		return obj, err
	}
	if val, err := deserialize_map_str_to_MetadataValue(deserializer); err == nil {
		obj.Field1 = val
	} else {
		return obj, err
	}
...
func serialize_tuple3_Array_map_str_to_MetadataValue_Similarity(value struct {
	Field0 Array
	Field1 map[string]MetadataValue
	Field2 Similarity
}, serializer serde.Serializer) error {
	...
	if err := value.Field2.Serialize(serializer); err != nil {
		return err
	}
	return nil
}

func deserialize_tuple3_Array_map_str_to_MetadataValue_Similarity(deserializer serde.Deserializer) (struct {
	Field0 Array
	Field1 map[string]MetadataValue
	Field2 Similarity
}, error) {
	...
	if val, err := DeserializeSimilarity(deserializer); err == nil {
		obj.Field2 = val
	} else {
		return obj, err
	}
...
func deserialize_vector_ConnectedClient(deserializer serde.Deserializer) ([]ConnectedClient, error) {
	...
	for i := range obj {
		if val, err := DeserializeConnectedClient(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_StoreInfo(deserializer serde.Deserializer) ([]StoreInfo, error) {
	...
	for i := range obj {
		if val, err := DeserializeStoreInfo(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func serialize_vector_f32(value []float32, serializer serde.Serializer) error {
	...
	for _, item := range value {
		if err := serializer.SerializeF32(item); err != nil {
			return err
		}
	}
	return nil
...
func serialize_vector_tuple2_Array_map_str_to_MetadataValue(value []struct {
	Field0 Array
	Field1 map[string]MetadataValue
}, serializer serde.Serializer) error {
	if err := serializer.SerializeLen(uint64(len(value))); err != nil {
	...
	for _, item := range value {
		if err := serialize_tuple2_Array_map_str_to_MetadataValue(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple2_Array_map_str_to_MetadataValue(deserializer serde.Deserializer) ([]struct {
	Field0 Array
	Field1 map[string]MetadataValue
}, error) {
	length, err := deserializer.DeserializeLen()
	...
	for i := range obj {
		if val, err := deserialize_tuple2_Array_map_str_to_MetadataValue(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func serialize_vector_tuple3_Array_map_str_to_MetadataValue_Similarity(value []struct {
	Field0 Array
	Field1 map[string]MetadataValue
	Field2 Similarity
}, serializer serde.Serializer) error {
	...
	for _, item := range value {
		if err := serialize_tuple3_Array_map_str_to_MetadataValue_Similarity(item, serializer); err != nil {
			return err
		}
	}
	return nil
...
func deserialize_vector_tuple3_Array_map_str_to_MetadataValue_Similarity(deserializer serde.Deserializer) ([]struct {
	Field0 Array
	Field1 map[string]MetadataValue
	Field2 Similarity
}, error) {
	...
	for i := range obj {
		if val, err := deserialize_tuple3_Array_map_str_to_MetadataValue_Similarity(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
