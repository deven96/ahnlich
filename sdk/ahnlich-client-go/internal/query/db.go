...
func (obj *Predicate__Equals) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(0)
	if err := serializer.SerializeStr(obj.Key); err != nil {
		return err
	}
...
func (obj *Predicate__In) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_MetadataValue(obj.Value, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Predicate__In(deserializer serde.Deserializer) (Predicate__In, error) {
	...
	if val, err := deserialize_vector_MetadataValue(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_PredicateCondition__Value(deserializer serde.Deserializer) (PredicateCondition__Value, error) {
	...
	if val, err := DeserializePredicate(deserializer); err == nil {
		obj.Value = val
	} else {
		return obj, err
	}
...
func load_PredicateCondition__And(deserializer serde.Deserializer) (PredicateCondition__And, error) {
	...
	if val, err := DeserializePredicateCondition(deserializer); err == nil {
		obj.Field0 = val
	} else {
		return obj, err
	}
...
func (obj *Query__CreateStore) Serialize(serializer serde.Serializer) error {
	...
	serializer.SerializeVariantIndex(0)
	if err := serializer.SerializeStr(obj.Store); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.Dimension); err != nil {
		return err
	}
	if err := serialize_vector_str(obj.CreatePredicates, serializer); err != nil {
		return err
	}
	if err := serialize_vector_NonLinearAlgorithm(obj.NonLinearIndices, serializer); err != nil {
		return err
	}
	if err := serializer.SerializeBool(obj.ErrorIfExists); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Query__CreateStore(deserializer serde.Deserializer) (Query__CreateStore, error) {
	...
	if val, err := deserialize_vector_str(deserializer); err == nil {
		obj.CreatePredicates = val
	} else {
		return obj, err
	}
	if val, err := deserialize_vector_NonLinearAlgorithm(deserializer); err == nil {
		obj.NonLinearIndices = val
	} else {
		return obj, err
	}
	if val, err := deserializer.DeserializeBool(); err == nil {
		obj.ErrorIfExists = val
	} else {
		return obj, err
	}
	deserializer.DecreaseContainerDepth()
...
func (obj *Query__GetKey) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_Array(obj.Keys, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Query__GetKey(deserializer serde.Deserializer) (Query__GetKey, error) {
	...
	if val, err := deserialize_vector_Array(deserializer); err == nil {
		obj.Keys = val
	} else {
		return obj, err
	}
...
func (obj *Query__GetPred) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.Condition.Serialize(serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *Query__GetSimN) Serialize(serializer serde.Serializer) error {
	...
	if err := obj.SearchInput.Serialize(serializer); err != nil {
		return err
	}
	if err := serializer.SerializeU64(obj.ClosestN); err != nil {
		return err
	}
	if err := obj.Algorithm.Serialize(serializer); err != nil {
		return err
	}
	if err := serialize_option_PredicateCondition(obj.Condition, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func load_Query__GetSimN(deserializer serde.Deserializer) (Query__GetSimN, error) {
	...
	if val, err := DeserializeAlgorithm(deserializer); err == nil {
		obj.Algorithm = val
	} else {
		return obj, err
	}
	if val, err := deserialize_option_PredicateCondition(deserializer); err == nil {
		obj.Condition = val
	} else {
		return obj, err
	}
...
func (obj *Query__CreatePredIndex) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_str(obj.Predicates, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *Query__DropPredIndex) Serialize(serializer serde.Serializer) error {
	...
	if err := serializer.SerializeBool(obj.ErrorIfNotExists); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *Query__Set) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_tuple2_Array_map_str_to_MetadataValue(obj.Inputs, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func (obj *ServerQuery) Serialize(serializer serde.Serializer) error {
	...
	if err := serialize_vector_Query(obj.Queries, serializer); err != nil {
		return err
	}
	serializer.DecreaseContainerDepth()
	return nil
...
func DeserializeServerQuery(deserializer serde.Deserializer) (ServerQuery, error) {
	...
	if val, err := deserialize_vector_Query(deserializer); err == nil {
		obj.Queries = val
	} else {
		return obj, err
	}
...
func deserialize_vector_NonLinearAlgorithm(deserializer serde.Deserializer) ([]NonLinearAlgorithm, error) {
	...
	for i := range obj {
		if val, err := DeserializeNonLinearAlgorithm(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
...
func deserialize_vector_Query(deserializer serde.Deserializer) ([]Query, error) {
	...
	for i := range obj {
		if val, err := DeserializeQuery(deserializer); err == nil {
			obj[i] = val
		} else {
			return nil, err
		}
