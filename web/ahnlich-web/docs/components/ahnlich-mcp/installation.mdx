...
### uv cannot resolve dependencies

Ahnlich MCP requires a pre-release version of `betterproto`. Upgrade to uv
0.12.0 or newer:
...
If you cannot upgrade, add this to your project's `pyproject.toml` and retry:
