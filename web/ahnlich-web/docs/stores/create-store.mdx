...
Create a new, isolated [store](/docs/stores) — Ahnlich's container for vectors and their metadata, like a *collection* in a document database or a *table* in a relational one.
