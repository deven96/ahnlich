---
title: 'Quickstart: Ahnlich AI'
sidebar_label: Ahnlich AI
description: Go from zero to semantic search over text in a few minutes — the AI proxy embeds your data for you.
---
...
Send **plain text** (or images) and let Ahnlich do the vector math for you — this
is the gentlest way in, with no need to understand embeddings or dimensions. Pick
your language — or the **CLI** for a no-code path — once below, and every sample on
this page follows your choice.

> **Bringing your own vectors instead?** Use the
> [Ahnlich DB quickstart](./quickstart-db) — same flow, but you supply the vectors.
...
{/*
  ============================================================================
  DUPLICATE COPY BELOW — leftover from the homepage/docs redesign merge conflict.
  This is an older, shorter version of the page (sections 1-4 only, no CLI tab).
  Commented out so the MDX build passes. Kept for reference; safe to delete.
  ============================================================================
