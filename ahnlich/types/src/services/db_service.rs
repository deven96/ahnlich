...
pub mod db_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn list_store_entries(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::db::query::ListStoreEntries>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::db::server::ListStoreEntries>,
            tonic::Status,
        > {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
        ...
        pub async fn upsert(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::db::query::Upsert>,
        ) -> std::result::Result<tonic::Response<super::super::super::db::server::Set>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/services.db_service.DBService/Upsert");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("services.db_service.DBService", "Upsert"));
            self.inner.unary(req, path, codec).await
        }
        /// * Delete methods *
        ...
        pub async fn drop_schema(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::db::query::DropSchema>,
        ) -> std::result::Result<tonic::Response<super::super::super::db::server::Del>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/services.db_service.DBService/DropSchema");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "services.db_service.DBService",
                "DropSchema",
        ...
        pub async fn clear_store(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::db::query::ClearStore>,
        ) -> std::result::Result<tonic::Response<super::super::super::db::server::Del>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/services.db_service.DBService/ClearStore");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "services.db_service.DBService",
                "ClearStore",
...
pub mod db_service_server {
    ...
    pub trait DbService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn list_store_entries(
            &self,
            request: tonic::Request<super::super::super::db::query::ListStoreEntries>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::db::server::ListStoreEntries>,
            tonic::Status,
        >;
        ...
        async fn upsert(
            &self,
            request: tonic::Request<super::super::super::db::query::Upsert>,
        ) -> std::result::Result<tonic::Response<super::super::super::db::server::Set>, tonic::Status>;
        /// * Delete methods *
        ...
        async fn drop_schema(
            &self,
            request: tonic::Request<super::super::super::db::query::DropSchema>,
        ) -> std::result::Result<tonic::Response<super::super::super::db::server::Del>, tonic::Status>;
        async fn clear_store(
            &self,
            request: tonic::Request<super::super::super::db::query::ClearStore>,
        ) -> std::result::Result<tonic::Response<super::super::super::db::server::Del>, tonic::Status>;
        /// * Ancillary info methods *
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/services.db_service.DBService/ListStoreEntries" => {
                    #[allow(non_camel_case_types)]
                    struct ListStoreEntriesSvc<T: DbService>(pub Arc<T>);
                    impl<T: DbService>
                        tonic::server::UnaryService<
                            super::super::super::db::query::ListStoreEntries,
                        > for ListStoreEntriesSvc<T>
                    {
                        type Response = super::super::super::db::server::ListStoreEntries;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DbService>::list_store_entries(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/services.db_service.DBService/Upsert" => {
                    #[allow(non_camel_case_types)]
                    struct UpsertSvc<T: DbService>(pub Arc<T>);
                    impl<T: DbService>
                        tonic::server::UnaryService<super::super::super::db::query::Upsert>
                        for UpsertSvc<T>
                    {
                        type Response = super::super::super::db::server::Set;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as DbService>::upsert(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/services.db_service.DBService/DropSchema" => {
                    #[allow(non_camel_case_types)]
                    struct DropSchemaSvc<T: DbService>(pub Arc<T>);
                    impl<T: DbService>
                        tonic::server::UnaryService<super::super::super::db::query::DropSchema>
                        for DropSchemaSvc<T>
                    {
                        type Response = super::super::super::db::server::Del;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as DbService>::drop_schema(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/services.db_service.DBService/ClearStore" => {
                    #[allow(non_camel_case_types)]
                    struct ClearStoreSvc<T: DbService>(pub Arc<T>);
                    impl<T: DbService>
                        tonic::server::UnaryService<super::super::super::db::query::ClearStore>
                        for ClearStoreSvc<T>
                    {
                        type Response = super::super::super::db::server::Del;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as DbService>::clear_store(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
