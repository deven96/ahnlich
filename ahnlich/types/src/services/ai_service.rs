...
pub mod ai_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("services.ai_service.AIService", "DropSchema"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("services.ai_service.AIService", "InfoServer"));
            self.inner.unary(req, path, codec).await
        }
            ...
            match req.uri().path() {
                ...
                "/services.ai_service.AIService/GetStore" => {
                    ...
                    impl<
                        T: AiService,
                    > tonic::server::UnaryService<
                        super::super::super::ai::query::GetStore,
                    > for GetStoreSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiService>::get_store(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/services.ai_service.AIService/DelPred" => {
                    ...
                    impl<
                        T: AiService,
                    > tonic::server::UnaryService<
                        super::super::super::ai::query::DelPred,
                    > for DelPredSvc<T> {
                        type Response = super::super::super::ai::server::Del;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiService>::del_pred(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/services.ai_service.AIService/DropSchema" => {
                    ...
                    impl<
                        T: AiService,
                    > tonic::server::UnaryService<
                        super::super::super::ai::query::DropSchema,
                    > for DropSchemaSvc<T> {
                        type Response = super::super::super::ai::server::Del;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiService>::drop_schema(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/services.ai_service.AIService/InfoServer" => {
                    ...
                    impl<
                        T: AiService,
                    > tonic::server::UnaryService<
                        super::super::super::ai::query::InfoServer,
                    > for InfoServerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiService>::info_server(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/services.ai_service.AIService/ConvertStoreInputToEmbeddings" => {
                    ...
                    > for ConvertStoreInputToEmbeddingsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiService>::convert_store_input_to_embeddings(
                                        &inner,
                                        request,
                                    )
                                    .await
