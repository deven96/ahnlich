...
pub mod ai_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_store(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::ai::query::GetStore>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/services.ai_service.AIService/GetStore");
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn del_pred(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::ai::query::DelPred>,
        ) -> std::result::Result<tonic::Response<super::super::super::ai::server::Del>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/services.ai_service.AIService/DelPred");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("services.ai_service.AIService", "DelPred"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn drop_schema(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::ai::query::DropSchema>,
        ) -> std::result::Result<tonic::Response<super::super::super::ai::server::Del>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/services.ai_service.AIService/DropSchema");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "services.ai_service.AIService",
                "DropSchema",
        ...
        pub async fn info_server(
            &mut self,
            request: impl tonic::IntoRequest<super::super::super::ai::query::InfoServer>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::ai::server::InfoServer>,
            tonic::Status,
        > {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/services.ai_service.AIService/InfoServer");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "services.ai_service.AIService",
                "InfoServer",
...
pub mod ai_service_server {
    ...
    pub trait AiService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_store(
            &self,
            request: tonic::Request<super::super::super::ai::query::GetStore>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::ai::server::AiStoreInfo>,
            tonic::Status,
        >;
        ...
        async fn del_pred(
            &self,
            request: tonic::Request<super::super::super::ai::query::DelPred>,
        ) -> std::result::Result<tonic::Response<super::super::super::ai::server::Del>, tonic::Status>;
        async fn drop_store(
            &self,
        ...
        async fn info_server(
            &self,
            request: tonic::Request<super::super::super::ai::query::InfoServer>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::ai::server::InfoServer>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/services.ai_service.AIService/GetStore" => {
                    #[allow(non_camel_case_types)]
                    struct GetStoreSvc<T: AiService>(pub Arc<T>);
                    impl<T: AiService>
                        tonic::server::UnaryService<super::super::super::ai::query::GetStore>
                        for GetStoreSvc<T>
                    {
                        type Response = super::super::super::ai::server::AiStoreInfo;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::super::super::ai::query::GetStore>,
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as AiService>::get_store(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/services.ai_service.AIService/DelPred" => {
                    #[allow(non_camel_case_types)]
                    struct DelPredSvc<T: AiService>(pub Arc<T>);
                    impl<T: AiService>
                        tonic::server::UnaryService<super::super::super::ai::query::DelPred>
                        for DelPredSvc<T>
                    {
                        type Response = super::super::super::ai::server::Del;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as AiService>::del_pred(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/services.ai_service.AIService/DropSchema" => {
                    #[allow(non_camel_case_types)]
                    struct DropSchemaSvc<T: AiService>(pub Arc<T>);
                    impl<T: AiService>
                        tonic::server::UnaryService<super::super::super::ai::query::DropSchema>
                        for DropSchemaSvc<T>
                    {
                        type Response = super::super::super::ai::server::Del;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as AiService>::drop_schema(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/services.ai_service.AIService/InfoServer" => {
                    #[allow(non_camel_case_types)]
                    struct InfoServerSvc<T: AiService>(pub Arc<T>);
                    impl<T: AiService>
                        tonic::server::UnaryService<super::super::super::ai::query::InfoServer>
                        for InfoServerSvc<T>
                    {
                        type Response = super::super::super::ai::server::InfoServer;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::super::super::ai::query::InfoServer>,
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as AiService>::info_server(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
