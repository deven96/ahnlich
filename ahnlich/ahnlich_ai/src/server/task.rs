                ...
                res = self.reader.read_exact(&mut magic_bytes_buf) => {
                    match res {
                        ...
                        Ok(_) => {
                            ...
                            match AIServerQuery::deserialize(&data) {
                                Ok(queries) => {
                            ...
                            Err(e) =>{
                                ...
                                let deserialize_error = AIServerResult::from_error(format!("{}", AIProxyError::QueryDeserializeError("".into()))).serialize().expect("Could not serialize deserialize error");
